...
#ifndef STARBOARD_RASPI_WAYLAND_CONFIGURATION_PUBLIC_H_
#define STARBOARD_RASPI_WAYLAND_CONFIGURATION_PUBLIC_H_
...
#endif  // STARBOARD_RASPI_WAYLAAND_CONFIGURATION_PUBLIC_H_
